# README.md 작성 방법 및 요령

- README는 해당 소프트웨어(프로그램)에 대한 정보(ex 사용법, 저작권, 프로젝트에 대한 설명 등)들을 기입해놓은 문서 파일이라고 생각하면 된다.

- README.md 를 포함한 다른 TIL을 기록할 때에도 .md 라는 확장자명을 사용한다. 이는 **M**ark**D**own 의 확장자 명이다.
